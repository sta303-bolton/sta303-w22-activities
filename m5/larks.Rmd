...
There is an optional video from last year talking through some of these functions [here](https://play.library.utoronto.ca/watch/b1276e3df811a7add3a40cfd3370e640).
...
Model residuals don't look too bad. The bands of points we see are due to working with integers. Some overdispersion, $\phi$ = `r round(crest3$scale,2)`$
