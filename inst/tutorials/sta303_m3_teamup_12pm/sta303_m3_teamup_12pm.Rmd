...
```{r, echo=FALSE, fig.align='center', out.width="50%", out.extra="HOLD"}
...
This question takes you theough the 'teaching and learning' world version of thinkinga bout sources of variance with random effects.
