---
title: "STA303: M3 Statdew Valley"
subtitle: "A statisitcal farming simulator"
...
knitr::include_graphics("images/statdewvalley.png")
```
...
knitr::include_graphics("images/lb-for-statdew-valley.png")
```

```{r, echo=FALSE, fig.align='center', out.width="50%"}
knitr::include_graphics("images/lb-example.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="100%"}
knitr::include_graphics("images/tomatoplot.png")
```
...
```{r bee_int_rss, exercise = TRUE, exercise.setup = "bee_wrangle"}

```

```{r, bee_int_rss-hint-1}
# Hint
...
```{r bee_int_rse, exercise = TRUE, exercise.setup = "bee_wrangle"}

```

```{r, bee_int_rse-hint-1}
...
nrow(summary(bee_int_mod)$coefficients)
```

```{r bee_int_rse-solution}
...
```{r setvarint, exercise = TRUE}

```

```{r setvarint-solution}
# Solution
var_int <- summary(bee_int_mod)$sigma^2
var_int
```
...
```{r agghive, exercise=TRUE, exercise.setup = "beesummary"}
...
```{r varhth, exercise=TRUE, exercise.setup = "beesummary"}
...
```{r, echo=FALSE}
knitr::include_graphics("images/fancyaveraging.png")
```
...
| In R                                | Notation                                                                      | RSE                                                                                                                                                                               |
+=====================================+===============================================================================+===================================================================================================================================================================================+
| `lm(honey_g ~ 1, data = honey_agg_hive)` | $y_{\cdot j \cdot} = \mu + \frac{1}{I}\Sigma^I_{i = 1}\alpha_i +  \epsilon_j$ | The $RSE^2$ here is hive-to-hive variation in average honey output (without taking into account the interaction between hive and song). We will use it to help find $\sigma_{b}$. |
|                                     |                                                                               |                                                                                                                                                                                   |
