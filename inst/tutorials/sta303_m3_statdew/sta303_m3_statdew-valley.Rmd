...
```{r tom_plot-hint-1}
# Any trouble with loadng the data? Paste this in to your coding area
tomatoes <- tibble(
  plant = rep(1:6, each = 4),
  fertilizer = rep(c("basic", "quality"), each = 12),
  weight = c(123, 124, 128, 125,
...
# Notice that the RSE here is just the variance of the average honey production for each hive
...
We've done pretty much everything we can while remaining in the ordinary least squares context, and even in the simplest examples, all the aggregating and model fitting we're doing will get a little tedious. Next we will turn to fitting **linear mixed models** more sophisticatedly with specialist packages.
