...
just2010 <- filter(tv_data_edit, decade == "2010")
t.test(tv_data_edit$av_rating, mu = 8.1, var.equal = TRUE)
```
...
If you get an erorr saying your data is missing, add the following code to the beginning of the code chunk to call it again.
