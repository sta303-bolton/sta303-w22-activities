---
title: "STA303: M2 tutorial activity"
...
In the web scraping content from this module, we talked about checking the robots.txt. We can use the `polite` package to check, from within R, whether it seems like this part of the site is allowed to be scraped, based on the robots.txt. 
...
# your code here (module 2 content)
