...
This case study is drawn from the content in [Chapter 4.10](https://bookdown.org/roback/bookdown-BeyondMLR/ch-poissonreg.html#cs:drinking) of Roback, P. & Legler, J. Beyond Multiple Linear Regression. (2021). https://bookdown.org/roback/bookdown-BeyondMLR/.

Below is the code, with minor alterations, that accompanies Chapter 4.10.
